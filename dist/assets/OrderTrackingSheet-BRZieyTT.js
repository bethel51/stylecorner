import{r as p,j as e}from"./index-DSATbR4S.js";import{e as A,M as C,b as F,D as R,d as $}from"./NotificationSheet-DthHhxnZ.js";import{u as L,f as k}from"./ScrollToTop-ChzaEbmb.js";import{C as P}from"./clock-CHIdq7HR.js";import{T as B}from"./StatusBadge-B80L15Jv.js";import{C as W}from"./circle-check-eFBDFC9J.js";import{S as E}from"./send-DDRBMXrm.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
