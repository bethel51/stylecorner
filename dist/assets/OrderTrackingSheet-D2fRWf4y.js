import{r as p,j as e}from"./index-DwuFMMM-.js";import{e as A,M as C,b as F,D as R,d as $}from"./NotificationSheet-BVYw2Odz.js";import{u as L,g as k}from"./ScrollToTop-C4Ks9Vgd.js";import{C as P}from"./clock-D2Hly904.js";import{T as B}from"./StatusBadge-D805Khbk.js";import{C as W}from"./circle-check-KqUFcl_f.js";import{S as E}from"./send-CQx2nzrK.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
