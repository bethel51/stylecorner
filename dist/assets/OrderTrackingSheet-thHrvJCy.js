import{r as p,j as e}from"./index-B_9nuqKY.js";import{e as A,M as C,b as F,D as R,d as $}from"./NotificationSheet-CQ-MW6NF.js";import{u as L,f as k}from"./ScrollToTop-DlOCp1F4.js";import{C as P}from"./clock-CqMkZR1p.js";import{T as B}from"./StatusBadge-C4OHV4LJ.js";import{C as W}from"./circle-check-DLKvTRSt.js";import{S as E}from"./send-CcD1fXRM.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
