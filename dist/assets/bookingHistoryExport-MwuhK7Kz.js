import{c,j as a}from"./index-UuWnUbNx.js";/**
 * @license lucide-react v0.439.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f=c("Activity",[["path",{d:"M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2",key:"169zse"}]]);/**
 * @license lucide-react v0.439.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g=c("History",[["path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8",key:"1357e3"}],["path",{d:"M3 3v5h5",key:"1xhq8a"}],["path",{d:"M12 7v5l4 2",key:"1fdv2h"}]]),p=()=>a.jsxs("div",{className:"app-card",style:{display:"flex",flexDirection:"column",gap:"0.75rem"},children:[a.jsx("div",{className:"skeleton",style:{height:"20px",width:"60%"}}),a.jsx("div",{className:"skeleton",style:{height:"14px",width:"90%"}}),a.jsx("div",{className:"skeleton",style:{height:"14px",width:"40%"}})]}),h=({count:o=3})=>a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"1rem"},children:Array.from({length:o}).map((r,n)=>a.jsx(p,{},n))}),y=(o,r="StyleCorner_Booking_History.csv")=>{if(!o||o.length===0)return!1;const n=["Booking ID","Service","Specialist / Stylist","Client Name","Client Email","Client Phone","Date","Time","Price (₦)","Status","Created At"],s=o.map(e=>[`"${e._id||""}"`,`"${(e.service||"").replace(/"/g,'""')}"`,`"${(e.stylist||"").replace(/"/g,'""')}"`,`"${(e.clientName||e.clientEmail||"").replace(/"/g,'""')}"`,`"${(e.clientEmail||"").replace(/"/g,'""')}"`,`"${(e.clientPhone||"").replace(/"/g,'""')}"`,`"${e.date||""}"`,`"${e.time||""}"`,`"${e.price||0}"`,`"${(e.status||"").toUpperCase()}"`,`"${e.createdAt?new Date(e.createdAt).toLocaleString():""}"`]),l="\uFEFF"+[n.join(","),...s.map(e=>e.join(","))].join(`\r
`),d=new Blob([l],{type:"text/csv;charset=utf-8;"}),t=URL.createObjectURL(d),i=document.createElement("a");return i.setAttribute("href",t),i.setAttribute("download",r),document.body.appendChild(i),i.click(),setTimeout(()=>{document.body.removeChild(i),URL.revokeObjectURL(t)},100),!0},u=(o,r="Booking History Statement")=>{if(!o||o.length===0)return!1;const n=window.open("","_blank");if(!n)return!1;const s=o.map((t,i)=>`
  ...
  `;return n.document.write(d),n.document.close(),!0};export{f as A,g as H,h as S,y as d,u as p};
