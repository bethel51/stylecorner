import{r as p,j as e}from"./index-C8Omn8aI.js";import{e as A,M as C,b as F,D as R,d as $}from"./NotificationSheet-D_tX4cAD.js";import{u as L,f as k}from"./ScrollToTop-DdVVEviP.js";import{C as P}from"./clock-C7G67FN-.js";import{T as B}from"./StatusBadge-DdCR3WP8.js";import{C as W}from"./circle-check-Cyj-qj3x.js";import{S as E}from"./send-AIv9_9O9.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
