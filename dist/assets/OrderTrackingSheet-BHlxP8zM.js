import{r as p,j as e}from"./index-D42folGT.js";import{e as A,M as C,b as F,D as R,d as $}from"./NotificationSheet-5jZ3tUUq.js";import{u as L,f as k}from"./ScrollToTop-Dq8wETdZ.js";import{C as P}from"./clock-CekJlEA8.js";import{T as B}from"./StatusBadge-DsPe9aHi.js";import{C as W}from"./circle-check-D--yo5Xh.js";import{S as E}from"./send-CoE-2-RR.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
