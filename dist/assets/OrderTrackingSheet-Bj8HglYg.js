import{r as p,j as e}from"./index-DdkfNAa_.js";import{e as A,M as C,b as F,D as R,d as $}from"./NotificationSheet-CyIO7_Jx.js";import{u as L,f as k}from"./ScrollToTop-IjDnYD__.js";import{C as P}from"./clock-CDqWBDKR.js";import{T as B}from"./StatusBadge-BaSq_3Vj.js";import{C as W}from"./circle-check-g7MJ8KFW.js";import{S as E}from"./send-Vbfw6Nfg.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
