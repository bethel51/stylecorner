import{r as p,j as e}from"./index-CMRKKFEB.js";import{e as A,M as C,b as F,D as R,d as $}from"./NotificationSheet-CtNMxDA6.js";import{u as L,f as k}from"./ScrollToTop-CVbWXXsK.js";import{C as P}from"./clock-Ai-_Ng0F.js";import{T as B}from"./StatusBadge-DdCvb1Og.js";import{C as W}from"./circle-check-94BqVomt.js";import{S as E}from"./send-4mT3popK.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
