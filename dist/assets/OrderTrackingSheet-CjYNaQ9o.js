import{r as p,j as e}from"./index-DWIGkC0j.js";import{e as A,M as C,b as F,D as R,d as $}from"./NotificationSheet-CG2U5DNr.js";import{u as L,g as k}from"./ScrollToTop-C3pXJsm8.js";import{C as P}from"./clock-AoP5Q8JN.js";import{T as B}from"./StatusBadge-o6vyfUVO.js";import{C as W}from"./circle-check-WqazNmSi.js";import{S as E}from"./send-Doj5OCiP.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
