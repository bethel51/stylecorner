import{f as A,r as p,x as F,M as C,j as e,B as R,D as $,i as L,a as k}from"./index-C_4Ufzjk.js";import{C as P}from"./clock-DKxg5VMi.js";import{T as B}from"./StatusBadge-2c8isdPX.js";import{C as W}from"./circle-check-CFFn5po6.js";import{S as E}from"./send-BA7jCZnA.js";const M=s=>{if(!s)return;const m=String(s._id||"").slice(-6).toUpperCase(),t=s.createdAt?new Date(s.createdAt).toLocaleDateString("en-NG",{weekday:"short",year:"numeric",month:"short",day:"numeric"}):new Date().toLocaleDateString(),r=window.open("","_blank","width=800,height=900");if(!r)return;const o=`
    <!DOCTYPE html>
    <html>
      <head>
